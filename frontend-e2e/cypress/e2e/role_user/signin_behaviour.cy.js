...
if (Cypress.browser.isHeaded) {
  ...
  describe("User can't log in with the hash string", () => {
    it.skip(
      'fails on github, passes locally',
      ...
      () => {
        ...
        cy.get('#loginPassword').type(
          '0NT3bCujDh6wvf5UTfXsjmlRhyEG6xvT1/kgiZPyjGk',
          { delay: 50 }
        );
        // cy.wait(500);
  ...
  describe('A new user can be created', () => {
    it.skip('under construction', { defaultCommandTimeout: 10000 }, () => {
      // to do: set db to initial state: delete user after the tests // elsewise, test is passing locally.
      cy.contains('Sign in').click();
