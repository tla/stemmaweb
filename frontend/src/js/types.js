 ...
 * @property {boolean} is_public - Whether the tradition should be viewable by other
 *   users.
 ...
 * @property {boolean} is_undirected - True if this is an undirected tree, rather than a
 *   directed stemma.
 * @property {boolean} is_contaminated - True if the stemma indicates witness
 *   contamination or conflation.
 * @property {string} newick - A string that holds the Newick specification of the tree
 *   topology.
 * @property {number} jobid
 * @property {string} dot - A string that holds the dot specification of the stemma or
 *   tree topology.
 * @property {string} identifier - The name (identifier) of the stemma. Must be unique
