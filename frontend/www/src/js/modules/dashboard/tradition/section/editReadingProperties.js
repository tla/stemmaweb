...
class EditReadingProperties {
    ...
    showDialog( readingId ) {
        if( userIsOwner() ) {
            ...
            const modal_body = `
                <form
                    id="edit-reading-properties-form"
    ...
    processForm() {
        ...
        if (form.checkValidity()) {
            const values = Object.values(
                editReadingProperties.#extractFormValuesSection()
            );
            ...
            return editPropertiesService
                ...
                .then( editReadingProperties.#handleUpdateSectionMetadataResponse );
        } else {
...
editReadingProperties = new EditReadingProperties();
